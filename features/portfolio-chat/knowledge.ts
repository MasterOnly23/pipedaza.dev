...
export const knowledge: KnowledgeTopic[] = [
  ...
  },
  {
    ...
    facts: [
      "Sus proyectos destacados incluyen ZentraStock, PartyUp y Kustral Finanzas. ZentraStock tiene una demo pública, PartyUp está en desarrollo y Kustral Finanzas es un proyecto privado sin acceso público.",
    ...
    factsEn: [
      "His featured projects include ZentraStock, PartyUp, and Kustral Finanzas. ZentraStock has a public demo, PartyUp is in development, and Kustral Finanzas is a private project without public access.",
